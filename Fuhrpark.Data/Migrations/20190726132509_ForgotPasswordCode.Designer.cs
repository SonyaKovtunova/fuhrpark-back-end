...
namespace Fuhrpark.Data.Migrations
{
    ...
    [Migration("20190726132509_ForgotPasswordCode")]
    partial class ForgotPasswordCode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fuhrpark.Models.AppUser", b =>
                {
                    ...
                    b.Property<string>("ForgotPasswordCodeToken");
            ...
            modelBuilder.Entity("Fuhrpark.Models.CarGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Fuhrpark.Models.CarInCarSubgroup", b =>
                {
                    b.Property<int>("CarId");

                    b.Property<int>("CarSubgroupId");

                    b.HasKey("CarId", "CarSubgroupId");

                    b.HasIndex("CarSubgroupId");

                    b.ToTable("CarInCarSubgroup");
                });
            ...
            modelBuilder.Entity("Fuhrpark.Models.CarSubgroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("CarSubgroup");
                });

            modelBuilder.Entity("Fuhrpark.Models.CarSubgroupInCarGroup", b =>
                {
                    b.Property<int>("CarSubgroupId");

                    b.Property<int>("CarGroupId");

                    b.HasKey("CarSubgroupId", "CarGroupId");

                    b.HasIndex("CarGroupId");

                    b.ToTable("CarSubgroupInCarGroup");
                });
            ...
            modelBuilder.Entity("Fuhrpark.Models.CarInCarSubgroup", b =>
                {
                    ...
                    b.HasOne("Fuhrpark.Models.CarSubgroup", "CarSubgroup")
                        .WithMany("CarInCarSubgroups")
                        .HasForeignKey("CarSubgroupId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Fuhrpark.Models.CarSubgroupInCarGroup", b =>
                {
                    b.HasOne("Fuhrpark.Models.CarGroup", "CarGroup")
                        .WithMany("CarSubgroupInCarGroups")
