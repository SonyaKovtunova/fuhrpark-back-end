...
namespace Fuhrpark.Host.Models
{
    public class CarSearchModel
    {
        ...
        public CarSpecSearchModel CarSpec { get; set; }

        public CarBusinessSearchModel CarBusiness { get; set; }

        public class CarSpecSearchModel
        {
        ...
        public class CarBusinessSearchModel
        {
